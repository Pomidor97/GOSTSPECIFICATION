...
{
    /// <summary>
    /// Обработчик для устройств данных (слаботочка)
    /// </summary>
    public class DataDeviceHandler : BaseElementHandler
    {
        public override BuiltInCategory Category => CategoryConstants.DataDevices;
