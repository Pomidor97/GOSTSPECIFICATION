...
{
    /// <summary>
    /// Обработчик для устройств связи и слаботочных систем
    /// </summary>
    public class CommunicationDeviceHandler : BaseElementHandler
    {
        private readonly BuiltInCategory _category;

        public override BuiltInCategory Category => _category;

        public CommunicationDeviceHandler(BuiltInCategory category)
        {
            _category = category;
        }
